# Practical Data Structures: Stacks, Queues, and Linked Lists
...
> **Note:** This lesson uses JavaScript. For the Java version, see [README-Java.md](./README-Java.md).
...
class SupportQueue {
  ...
  processTicket(){
    console.log("Processing:", this.queue.dequeue())
  }
}
```
...
- [JavaScript Data Structures](https://www.geeksforgeeks.org/javascript-data-structures/)
...
For the Java implementation of these lessons, see [README-Java.md](./README-Java.md).
